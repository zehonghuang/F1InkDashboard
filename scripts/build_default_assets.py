...
def main():
    ...
    parser.add_argument('--text_font_path', help='Explicit text font file path to include in assets')
    ...
    if not args.esp_sr_model_path or not args.xiaozhi_fonts_path:
        ...
        if not args.xiaozhi_fonts_path:
            args.xiaozhi_fonts_path = os.path.join(project_root, "main", "components", "78__xiaozhi-fonts")
    ...
    print(f"  text_font_path: {args.text_font_path}")
    ...
    text_font_path = args.text_font_path or get_text_font_path(args.builtin_text_font, args.xiaozhi_fonts_path)
