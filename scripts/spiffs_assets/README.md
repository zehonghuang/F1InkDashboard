...
# 仅处理字体文件
./build.py --text_font ../../main/components/78__xiaozhi-fonts/build/font_puhui_common_20_4.bin

# 仅处理表情符号
./build.py --emoji_collection ../../main/components/78__xiaozhi-fonts/build/emojis_64/
```
