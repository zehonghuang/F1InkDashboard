...
const docTemplate = `{
        ...
        "/api/v1/mp/news/ingest": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "文章对象（published_at 为 RFC3339/RFC3339Nano，示例：2026-05-25T18:30:00+08:00 或 2026-05-25T10:30:00Z；content.nodes 为小程序 rich-text nodes 结构：元素节点 {name,attrs,children}，文本节点 {type:\\",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/toinc_f1_backend_internal_model.MpNewsIngestRequestSwagger"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/toinc_f1_backend_internal_model.MpNewsIngestResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "toinc_f1_backend_internal_model.MpNewsContent": {
            ...
            "properties": {
                ...
                "nodes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/toinc_f1_backend_internal_model.MpNewsRichTextNode"
                    }
                },
                "text": {
                    "type": "string"
        ...
        "toinc_f1_backend_internal_model.MpNewsContentSwagger": {
            "type": "object",
            "properties": {
                "format_code": {
                    "type": "string",
                    "example": "RICH_TEXT_NODES"
                },
                "nodes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/toinc_f1_backend_internal_model.MpNewsRichTextNodeAny"
                    }
                },
                "text": {
                    "type": "string"
        ...
        "toinc_f1_backend_internal_model.MpNewsIngestRequestSwagger": {
            "type": "object",
            "properties": {
                "content": {
                    "$ref": "#/definitions/toinc_f1_backend_internal_model.MpNewsContentSwagger"
                },
                "cover_url": {
                    "type": "string",
                    "example": "/static/news/f1-wolff-antonelli-russell.webp"
                },
                "hero_display_code": {
                    "allOf": [
                        {
                ...
                "id": {
                    "type": "string",
                    "example": "n_f1_antonelli_russell_wolff"
                },
                "layout_code": {
                    "allOf": [
                        {
                ...
                "published_at": {
                    "type": "string",
                    "example": "2026-05-25T18:30:00+08:00"
                },
                "source": {
                ...
                "summary": {
                    "type": "string",
                    "example": "基于 Formula1.com 报道要点的中文改写"
                },
                "tag_text": {
                    "type": "string",
                    "example": "Mercedes / 采访"
                ...
                "title": {
                    "type": "string",
                    "example": "沃尔夫谈队内竞争：允许安东内利与拉塞尔硬碰硬，但会设底线"
                },
                "type_code": {
                    "allOf": [
                        {
        ...
        "toinc_f1_backend_internal_model.MpNewsIngestResponse": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "string"
        ...
        "toinc_f1_backend_internal_model.MpNewsRichTextNode": {
            "type": "object",
            "properties": {
                "attrs": {
                    "type": "object",
        ...
        "toinc_f1_backend_internal_model.MpNewsRichTextNodeAny": {
            "type": "object",
            "properties": {
                "attrs": {
                    "type": "object",
