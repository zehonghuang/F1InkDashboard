...
public:
    ...
    inline std::shared_ptr<LvglFont> reminder_text_font() const { return reminder_text_font_; }
    ...
    inline void set_reminder_text_font(std::shared_ptr<LvglFont> text_font) { reminder_text_font_ = text_font; }
...
private:
    ...
    std::shared_ptr<LvglFont> reminder_text_font_ = nullptr;
