...
static void gfx_label_snap_timer_callback(void *arg)
{
    ...
    ESP_LOGI(TAG, "aligned_offset: %" PRIi32 ", text_width: %" PRIi32 ", scroll_offset: %" PRIi32,
             (int32_t)(label->scroll.scroll_offset - aligned_offset),
             (int32_t)label->scroll.text_width,
             (int32_t)label->scroll.scroll_offset);
