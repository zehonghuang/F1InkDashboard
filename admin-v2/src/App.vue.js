...
function renderNewsContent(item) {
    if (!item?.content)
        return '<p>暂无内容</p>';
...
if (__VLS_ctx.currentView === 'dashboard') {
    ...
    for (const [item] of __VLS_getVForSourceType((__VLS_ctx.dashboardSummary?.latestNews || []))) {
        ...
        (item.tag_text || '未分类');
        (__VLS_ctx.formatShort(item.published_at));
    }
    ...
    if (__VLS_ctx.selectedNews) {
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.strong, __VLS_intrinsicElements.strong)({});
        (__VLS_ctx.formatDateTime(__VLS_ctx.selectedNews.published_at));
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
            ...{ class: "detail-item" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...
    for (const [item] of __VLS_getVForSourceType((__VLS_ctx.deviceItems))) {
        ...
        (item.fw_user_agent || '--');
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
        (__VLS_ctx.formatShort(item.last_seen_at));
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
    ...
    if (__VLS_ctx.selectedDevice) {
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.strong, __VLS_intrinsicElements.strong)({});
        (__VLS_ctx.formatDateTime(__VLS_ctx.selectedDevice.first_seen_at));
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
            ...{ class: "detail-item" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.strong, __VLS_intrinsicElements.strong)({});
        (__VLS_ctx.formatDateTime(__VLS_ctx.selectedDevice.last_seen_at));
        __VLS_asFunctionalElement(__VLS_intrinsicElements.section, __VLS_intrinsicElements.section)({
            ...{ class: "panel" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...
    for (const [item] of __VLS_getVForSourceType((__VLS_ctx.userItems))) {
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
        (__VLS_ctx.formatShort(item.updated_at || item.created_at));
    }
    if (__VLS_ctx.selectedUser) {
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.strong, __VLS_intrinsicElements.strong)({});
        (__VLS_ctx.formatDateTime(__VLS_ctx.selectedUser.created_at));
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
            ...{ class: "detail-item" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.strong, __VLS_intrinsicElements.strong)({});
        (__VLS_ctx.formatDateTime(__VLS_ctx.selectedUser.updated_at));
        __VLS_asFunctionalElement(__VLS_intrinsicElements.section, __VLS_intrinsicElements.section)({
            ...{ class: "panel" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...
    if (__VLS_ctx.currentLiveTab === 'f1') {
        ...
        (__VLS_ctx.formatShort(__VLS_ctx.f1Snapshot?.last_updated_at_utc));
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
            ...{ class: "stat-note" },
        });
        ...
        for (const [item] of __VLS_getVForSourceType((__VLS_ctx.latestMessages))) {
            ...
            (__VLS_ctx.formatShort(item.utc));
        }
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.strong, __VLS_intrinsicElements.strong)({});
        (__VLS_ctx.formatDateTime(__VLS_ctx.liveStandings?.fetched_at_utc));
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
            ...{ class: "footer-note" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsicElements.section, __VLS_intrinsicElements.section)({
