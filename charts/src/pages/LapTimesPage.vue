...
import { renderLapTimeChart } from "../charts";
...
const { titleMain, titleSub } = useSessionMeta(sessionKey, { pageTitle: "圈速" });
...
const load = async () => {
  ...
  try {
    ...
    chart = renderLapTimeChart(chartEl.value, labels, laps, { driverColor: driverColor.value });
