  ...
  lifetimes: {
    attached() {
      ...
      try {
        ...
        const statusBarH = this.properties.statusBarHeight != null ? this.properties.statusBarHeight : h
        const tabbarRpx = this.properties.tabbarReserveRpx != null ? this.properties.tabbarReserveRpx : layout.tabbarReserveRpx
        this.setData({ statusBarHeight: statusBarH, scrollViewStyle: layout.scrollViewStyle, tabbarReserveRpx: tabbarRpx })
      } catch (e) {
        const tabbarRpx = this.properties.tabbarReserveRpx != null ? this.properties.tabbarReserveRpx : layout.tabbarReserveRpx
        this.setData({ scrollViewStyle: layout.scrollViewStyle, tabbarReserveRpx: tabbarRpx })
      }
      this.applyI18n()
      this.loadArchive()
    },
