...
const ZH_CN = {
  ...
  mine: {
    ...
    wechatGroupFab: "群",
    wechatGroupTitle: "微信群聊",
    wechatGroupHint: "扫码加入车迷交流群",
    wechatGroupPreviewHint: "点击二维码可放大查看",
    wechatGroupFakeHint: "演示占位二维码，后续替换成真实群码即可",
    wechatGroupFakePreview: "当前是演示二维码",
    wechatGroupQrMissing: "请先在 app.js 或全局配置里放入真实微信群二维码图片",
    logout: "退出登录",
    language: "语言"
  },
  liveTiming: {
...
const EN_US = {
  ...
  mine: {
    ...
    wechatGroupHint: "Scan the QR code to join the community group",
    wechatGroupPreviewHint: "Tap the QR code to preview it",
    wechatGroupFakeHint: "Demo placeholder QR. Replace it later with the real group code.",
    wechatGroupFakePreview: "This is a demo QR for now",
    wechatGroupQrMissing: "Add a real WeChat group QR image in app.js or global config first",
    logout: "Logout",
    language: "Language"
  },
  liveTiming: {
